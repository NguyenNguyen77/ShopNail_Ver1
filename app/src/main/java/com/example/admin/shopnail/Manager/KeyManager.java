...
public class KeyManager {
    ...
    public static final String PASS_WORD_NEW = "password_new";
    public static final String PASS_WORD_CONFIRMATION = "password_confirmation";
    ...
    public static final String CHECK_TIME_BOOK_ONLINE = "CHECK_TIME_BOOK_ONLINE";
